...
class BirthdateRequestViewController: UIViewController {
    ...
    func showAC() {
        let ac = UIAlertController(title: "Title.Text".localized, message: nil, preferredStyle: .alert)
        ac.view.translatesAutoresizingMaskIntoConstraints = false
        ac.addTextField { textField in
            textField.placeholder = "DD.MM.YY.Text".localized
        ...
        let okAction = UIAlertAction(title: "Continue.Text".localized, style: .default) { [weak self] _ in
